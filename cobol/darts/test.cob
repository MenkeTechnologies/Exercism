      ...
      *-------- "Just within the inner circle"                                  
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just within the inner circle"                                  
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 0.7 TO WS-X                                                    
            MOVE 0.7 TO WS-Y                                                    
      ...
      *-------- "Just outside the inner circle"                                 
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just outside the inner circle"                                 
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 0.8 TO WS-X                                                    
            MOVE -0.8 TO WS-Y                                                   
      ...
      *-------- "Just within the middle circle"                                 
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just within the middle circle"                                 
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE -3.5 TO WS-X                                                   
            MOVE 3.5 TO WS-Y                                                    
      ...
      *-------- "Just outside the middle circle"                                
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just outside the middle circle"                                
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE -3.6 TO WS-X                                                   
            MOVE -3.6 TO WS-Y                                                   
      ...
      *-------- "Just within the outer circle"                                  
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just within the outer circle"                                  
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE -7 TO WS-X                                                     
            MOVE 7 TO WS-Y                                                      
      ...
      *-------- "Just outside the outer circle"                                 
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Just outside the outer circle"                                 
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 7.1 TO WS-X                                                    
            MOVE -7.1 TO WS-Y                                                   
           ...
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-AFTER-EACH                                                
      *-------- "Asymmetric position between the inner and middle circle        
      * s"                                                                      
           MOVE SPACES                                                          
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-BEFORE-EACH                                               
           MOVE "Asymmetric position between the inner and middle circle        
      -    "s"                                                                  
               TO UT-TEST-CASE-NAME                                             
           PERFORM UT-INITIALIZE-MOCK-COUNT                                     
            MOVE 0.5 TO WS-X                                                    
