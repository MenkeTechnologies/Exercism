...
public class CustomSetTests
{
    ...
    {
        var sut = new CustomSet.CustomSet.CustomSet();
    ...
    {
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1 });
    ...
    {
        var element = 1;
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet();
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 1 });
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.True(sut.Subset(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.True(sut.Subset(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 4, 1, 2, 3 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.True(sut.Subset(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 4, 1, 3 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.False(sut.Subset(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 2, 3 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2 });
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 3, 4 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2 });
        Assert.True(sut.Disjoint(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 2, 1 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2 });
        Assert.True(sut.Equals(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 4 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.False(sut.Equals(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.False(sut.Equals(set2));
    }
    ...
    public void Add_to_empty_set()
    {
        var element = 3;
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 3 }), sut.Add(element));
    }
    ...
    {
        var element = 3;
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 4 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 }), sut.Add(element));
    }
    ...
    public void Adding_an_existing_element_does_not_change_the_set()
    {
        var element = 3;
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 }), sut.Add(element));
    }
    ...
    public void Intersection_of_two_empty_sets_is_an_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Intersection(set2));
    }

    [Fact]
    public void Intersection_of_an_empty_set_and_non_empty_set_is_an_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 3, 2, 5 });
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Intersection(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Intersection(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 4, 5, 6 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Intersection(set2));
    }
    ...
    public void Intersection_of_two_sets_with_shared_elements_is_a_set_of_the_shared_elements()
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 3, 2, 5 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 2, 3 }), sut.Intersection(set2));
    }
    ...
    public void Difference_of_two_empty_sets_is_an_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Difference(set2));
    }
    ...
    public void Difference_of_a_non_empty_set_and_an_empty_set_is_the_non_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 1, 2, 3, 4 }), sut.Difference(set2));
    }

    [Fact]
    public void Difference_of_two_non_empty_sets_is_a_set_of_elements_that_are_only_in_the_first_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 2, 4 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 3, 2, 1 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 1, 3 }), sut.Difference(set2));
    }
    ...
    public void Union_of_empty_sets_is_an_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(), sut.Union(set2));
    }

    [Fact]
    public void Union_of_an_empty_set_and_non_empty_set_is_the_non_empty_set()
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 2 });
        var sut = new CustomSet.CustomSet.CustomSet();
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 2 }), sut.Union(set2));
    }
    ...
    {
        var set2 = new CustomSet.CustomSet.CustomSet();
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 3 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 1, 3 }), sut.Union(set2));
    }
    ...
    public void Union_of_non_empty_sets_contains_all_unique_elements()
    {
        var set2 = new CustomSet.CustomSet.CustomSet(new[] { 2, 3 });
        var sut = new CustomSet.CustomSet.CustomSet(new[] { 1, 3 });
        Assert.Equal(new CustomSet.CustomSet.CustomSet(new[] { 3, 2, 1 }), sut.Union(set2));
    }
}
