...
is(
    ...
    "2013-03-25", "last Monday in a month with four Mondays",
);

is(
    meetup("Last Monday of April 2013"),
    "2013-04-29", "last Monday in a month with five Mondays",
);

is(
    meetup("Last Tuesday of May 2013"),
    "2013-05-28", "last Tuesday in a month with four Tuesdays",
);

is(
    meetup("Last Tuesday of June 2013"),
    "2013-06-25", "last Tuesday in another month with four Tuesdays",
);

is(
    meetup("Last Wednesday of July 2013"),
    "2013-07-31", "last Wednesday in a month with five Wednesdays",
);

is(
    meetup("Last Wednesday of August 2013"),
    "2013-08-28", "last Wednesday in a month with four Wednesdays",
);

is(
    meetup("Last Thursday of September 2013"),
    "2013-09-26", "last Thursday in a month with four Thursdays",
);

is(
    meetup("Last Thursday of October 2013"),
    "2013-10-31", "last Thursday in a month with five Thursdays",
);

is(
    meetup("Last Friday of November 2013"),
    "2013-11-29", "last Friday in a month with five Fridays",
);

is(
    meetup("Last Friday of December 2013"),
    "2013-12-27", "last Friday in a month with four Fridays",
);

is(
    meetup("Last Saturday of January 2013"),
    "2013-01-26", "last Saturday in a month with four Saturdays",
);

is(
    meetup("Last Saturday of February 2013"),
    "2013-02-23", "last Saturday in another month with four Saturdays",
);

is(
    meetup("Last Sunday of March 2013"),
    "2013-03-31", "last Sunday in a month with five Sundays",
);

is(
    meetup("Last Sunday of April 2013"),
    "2013-04-28", "last Sunday in a month with four Sundays",
);

is(
    meetup("Last Wednesday of February 2012"),
    "2012-02-29", "when last Wednesday in February in a leap year is the 29th",
);
