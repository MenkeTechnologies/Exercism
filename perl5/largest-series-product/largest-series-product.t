...
is(
    ...
    18, "finds the largest product if span equals length",
);

is(
    largest_product( "0123456789", 2 ),
    72, "can find the largest product of 2 with numbers in order",
);

is(
    largest_product( "576802143", 2 ),
    48, "can find the largest product of 2",
);

is(
    largest_product( "0123456789", 3 ),
    504, "can find the largest product of 3 with numbers in order",
);

is(
    largest_product( "1027839564", 3 ),
    270, "can find the largest product of 3",
);

is(
    largest_product( "0123456789", 5 ),
    15120, "can find the largest product of 5 with numbers in order",
);
...
is(
    ...
    0, "reports zero if the only digits are zero",
);

is(
    largest_product( "99099", 3 ),
    0, "reports zero if all spans include zero",
);
...
is(
    largest_product( "", 0 ),
    1, "reports 1 for empty string and empty product (0 span)",
);

is(
    largest_product( "123", 0 ),
    1, "reports 1 for nonempty string and empty product (0 span)",
);
