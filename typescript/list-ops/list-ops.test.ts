...
describe('filter list returning only items that satisfy the filter function', () => {
  it('empty list', () => {
    const list1 = List.create()
...
describe('returns a list of elements whose items equal the list value transformed by the mapping function', () => {
  it('empty list', () => {
    const list1 = List.create()
